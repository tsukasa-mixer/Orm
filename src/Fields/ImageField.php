...
use Tsukasa\Exceptions\UnknownMethodException;
use Tsukasa\Exceptions\UnknownPropertyException;
use Tsukasa\Helpers\FileHelper;
use Tsukasa\Traits\ImageProcess;
...
//                    'detectCorrupted' => $this->detectCorrupted,
     ...
     * @return string
     * @throws \Exception
     * @throws \Tsukasa\Exceptions\Exception
     * @throws \Tsukasa\Exceptions\UnknownMethodException
     * @throws \Tsukasa\Exceptions\UnknownPropertyException
     */
