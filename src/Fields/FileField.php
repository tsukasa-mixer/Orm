...
use Tsukasa\Storage\Files\File;
use Tsukasa\Storage\Files\LocalFile;
use Tsukasa\Storage\Files\ResourceFile;
...
class FileField extends CharField
{
    ...
    /**
     * @param \Tsukasa\Orm\Model|ModelInterface $model
     * @param $value
     */
    ...
    public function getFormField($form, $fieldClass = '\Tsukasa\Form\Fields\FileField', array $extra = [])
    {
