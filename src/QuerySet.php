...
class QuerySet extends QuerySetBase
{
     ...
     * @param int $batchSize
     *
     * @return \Tsukasa\Orm\BatchDataIterator
     * @throws \Exception
     */
     ...
     * @param array $attributes
     *
     * @return array [\Tsukasa\Orm\Model, isNew]
     * @throws
     */
     ...
     * @param array $attributes
     *
     * @return array[\Tsukasa\Orm\Model, boolean]
     * @throws
     */
     ...
     *
     * @return array [null|\Tsukasa\Orm\ModelInterface|\Tsukasa\Orm\Orm, isNew]
     * @throws
     */
